#!/bin/sh
TMP_CID_FILE=tmp/payara.cid
DOCKER_IMAGE_NAME=payara:4.1.152
DOCKER_CONTAINER_NAME=payara
...
echo "Payara is starting... "
sleep 5
echo "Open Payara Admin Console at http://${ADMIN_IP}:${DEFAULT_ADMIN_PORT}/"
